...
def coordinates():
    ...
    educational_content = {
    "Good": {
        "text": "The ground water quality is good and the more .",
        "video_id": "https://youtu.be/lYfJTm00dcc"
    },
    "Poor": {
        "text": "The ground water quality is not good you can get more information on .",
        "video_id": "https://youtu.be/lYfJTm00dcc"
    }
}
    ...
    return jsonify({
        ...
        "educational_content": educational_content[label_map[prediction[0]]]
    })
